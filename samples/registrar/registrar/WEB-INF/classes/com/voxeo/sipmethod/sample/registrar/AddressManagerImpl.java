...
@WebService (endpointInterface="com.voxeo.sipmethod.sample.registrar.AddressManager")
public class AddressManagerImpl {
  ...
  public MapWrapper getRegisteredAddresses() {
    ...
    Map<String, URI> addresses = (Map<String, URI>) m_context.getAttribute("com.micromethod.sipmethod.sample.register.Addresses");
    if (addresses != null) {
  ...
  public boolean removeRegister(String uri) {
    if (uri != null) {
      ...
      if (addresses != null) {
        ...
        Object ret = addresses.remove(uri.trim());
        
        if (ret != null) {
          // reset addresses map in context attribute for replication.
          m_context.setAttribute("com.micromethod.sipmethod.sample.register.Addresses", addresses);
          return true;
        }
      }
    }
