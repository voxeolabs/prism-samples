 ...
 * generated in the com.voxeo.sipmethod.sample.registrar package. 
...
public class ObjectFactory {
    ...
    private final static QName _MapWrapper_QNAME = new QName("http://registrar.sample.sipmethod.voxeo.com/", "mapWrapper");
    private final static QName _RemoveRegister_QNAME = new QName("http://registrar.sample.sipmethod.voxeo.com/", "removeRegister");
    private final static QName _GetRegisteredAddressesResponse_QNAME = new QName("http://registrar.sample.sipmethod.voxeo.com/", "getRegisteredAddressesResponse");
    private final static QName _RemoveRegisterResponse_QNAME = new QName("http://registrar.sample.sipmethod.voxeo.com/", "removeRegisterResponse");
    private final static QName _GetRegisteredAddresses_QNAME = new QName("http://registrar.sample.sipmethod.voxeo.com/", "getRegisteredAddresses");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.voxeo.sipmethod.sample.registrar
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://registrar.sample.sipmethod.voxeo.com/", name = "mapWrapper")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://registrar.sample.sipmethod.voxeo.com/", name = "removeRegister")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://registrar.sample.sipmethod.voxeo.com/", name = "getRegisteredAddressesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://registrar.sample.sipmethod.voxeo.com/", name = "removeRegisterResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://registrar.sample.sipmethod.voxeo.com/", name = "getRegisteredAddresses")
